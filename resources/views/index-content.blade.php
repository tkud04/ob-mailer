                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Ob Mailer 2.0</h4>
                            </div>
                            <div class="card-body">
                                <form action="#">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" id="senderEmail" class="form-control form-control-danger" placeholder="john@yahoo.com" value="ceokhalifawali@gmail.com">
										...
										<div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" id="link" class="form-control form-control-danger" placeholder="www.yourlink.com" value="none"> 
													</div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="SMTPServer" placeholder="SMTP server domain or IP address" value="smtp.gmail.com">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="SMTPPort" placeholder="SMTP port" value="587">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="SMTPUser" placeholder="SMTP username" value="ceokhalifawali@gmail.com">
